...
sub run {
    ...
    my $new_deployer_vm_name = sdaf_gen_deployer_name();
    ...
    sdaf_get_deployer_ip(deployer_resource_group=>$deployer_resource_group, deployer_vm_name=>$new_deployer_vm_name);
