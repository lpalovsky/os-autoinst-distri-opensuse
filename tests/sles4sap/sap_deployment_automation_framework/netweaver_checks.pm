...
Module executes post deployment checks and status screens about ABAP stack and ENSA2 cluster.
...
sub run {
    ...
    my %ensa2_hosts = %{ $redirection->get_ensa2_hosts };
    my %nw_hosts = %{ $redirection->get_nw_hosts };
    my $instance_data;
