...
subtest '[prepare_tfvars_file] Test curl commands' => sub {
    ...
    my %expected_results = (
        deployer => 'curl -v -fL http://openqa.suse.de/data/sles4sap/sap_deployment_automation_framework/CONTROL_PLANE_DEPLOYER.tfvars -o deployer_parameter_file',
        ...
        library => 'curl -v -fL http://openqa.suse.de/data/sles4sap/sap_deployment_automation_framework/CONTROL_PLANE_LIBRARY.tfvars -o library_parameter_file'
    );
