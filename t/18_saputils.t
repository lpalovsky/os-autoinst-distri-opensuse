...
subtest '[get_primary_node] starting and failed' => sub {
    ...
    is get_primary_node(input => $mock_input), 'hana_node_01', 'Return correct primary node name';
};
...
subtest '[get_failover_node] starting and failed' => sub {
    ...
    is get_failover_node(input => $mock_input), 'hana_node_02', 'Return correct primary node name';
};
