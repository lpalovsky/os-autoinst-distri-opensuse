...
subtest '[find_deployment_id] Test expected failures' => sub {
    ...
    $mock_function->redefine(get_parents => sub { return ['0083']; });
    $mock_function->redefine(get_deployer_vm => sub { return '0079'; });
...
subtest '[find_deployer_resources] Check command composition' => sub {
  ...
  "0079-Zaku_II_VM"
    ...
    find_deployer_resources(deployer_resource_group => 'Char', deployment_id => '0079', return_ids => 1);
